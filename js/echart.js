$(function() {
    ...
    function ceshis1() {
        ...
        var xdata = ['时尚女鞋', "童鞋", "休闲鞋", "手工布鞋", '拖鞋', '莴笋', '洋芋', '藕', '豌豆', '玉米'];
        ...
        option = {
            ...
            series: [

                {
                    ...
                    data: [20.5, 21.3, 19.6, 19, 10, 9, 6, 8, 9, 25,20, 3]
                },
                {
                    name: '产值',
                    type: 'bar',
                    ...
                    data: [2.0, 2.1,  1.3, 1.3, 1.2, 0.5, 0.4, 0.4, 0.6, 2.0, 1.8, 0.2]
                },
                // {
                //     name: '同比增加',
                //     type: 'line',
                ...
                // },
                {
                    ...
                    data: [4.1, 4.26, 5.2, 4.0, 4.2, 3.8, 2.2, 2.1, 2.7, 5.3,5.4, 2.3],
                    // data: [20.5, 21.3, 19.6, 19, 10, 9, 6, 8, 9, 25,20, 3],
                    lineStyle: {
                        normal: {
                            width: 5,
